...
export default {
  ...
  'bl.writeAll': 'Write all to device',
  'bl.slot': 'Slot',
  'bl.slotName': 'Name',
  'bl.oversize': 'TOO LARGE',
  'blupdate.title': 'Update Single Firmware',
  'blupdate.modeNotice': '(Requires losehu bootloader mode)',
  'blupdate.howToConnect': 'Power off the radio → hold MENU button → power on → connect here. The version shown should be "L_BL003" (or similar). Do NOT use Quansheng programming mode (PTT + power on).',
  'blupdate.wrongProtocol': 'Connected firmware "{version}" does not support 32-bit EEPROM access. Boot into bootloader mode first (hold MENU on power-on), then reconnect.',
  'blupdate.readSlots': 'Read slots from device',
  'blupdate.colIndex': '#',
  'blupdate.colName': 'Name',
  'blupdate.colStart': 'Start',
  'blupdate.colEnd': 'End',
  'blupdate.colSize': 'Size',
  'blupdate.colAction': 'Action',
  'blupdate.select': 'Select',
  'blupdate.selected': 'Selected ✓',
  'blupdate.selectFirmware': 'Select .bin file',
  'blupdate.slotName': 'Slot name:',
  'blupdate.sizeError': 'Firmware is too large for this slot (max {max} KB). Select a smaller binary.',
  'blupdate.writeSlot': 'Flash slot {index} ("{name}") with new firmware',
  'cs': 'Coming Soon',
